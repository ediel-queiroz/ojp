...
- [documents/XA_MULTINODE_FAILOVER.md](documents/XA_MULTINODE_FAILOVER.md) - Comprehensive guide to automatic retry and failover for XA transactions when OJP servers fail in multinode clusters
...
- [documents/XA_MULTINODE_FAILOVER.md](documents/XA_MULTINODE_FAILOVER.md) - Multinode failover guide
